    ...
    <main className="relative flex min-h-[100dvh] w-full items-center overflow-hidden bg-[var(--bp-bg)] px-4 py-8 text-[var(--bp-text)] sm:px-6 sm:py-10 lg:px-10">
      ...
      <section className="relative mx-auto grid w-full max-w-5xl items-center gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
        <div className="hidden lg:block">
          <Image src="/asset/BINLINPAD.png" alt="BinlinPad" width={220} height={64} priority className="h-auto w-56" style={{ width: 'auto', height: 'auto' }} />
        ...
        <div className="mx-auto w-full max-w-md">
          <div className="mb-7 lg:hidden">
            <Image src="/asset/BINLINPAD.png" alt="BinlinPad" width={220} height={64} priority className="h-auto w-[min(220px,75vw)]" style={{ width: 'auto', height: 'auto' }} />
          </div>
